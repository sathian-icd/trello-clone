(function (global, factory) {
	...
	*/
	  ...
	  return function wrapWithConnect(WrappedComponent) {
	    ...
	    function ConnectFunction(props) {
	      ...
	      var renderedChild = React.useMemo(function () {
	        ...
	        var renderedWrappedComponent = React__default.createElement(WrappedComponent, _extends$1({}, actualChildProps, {
	          ref: forwardedRef
	        }));
	...
	var parse = function parse(raw) {
	  ...
	  !(suffix === 'px') ? invariant$2(false, "Expected value to be a pixel value.\n      Expected form: 10px\n      Actual value: " + raw + "\n    ") : void 0;
	...
	var adjustExistingForAdditionsAndRemovals = (function (_ref) {
	  ...
	  toDroppableList(droppables).forEach(function (droppable) {
	    ...
	    var removals = toDraggableMap(removedDraggables.map(function (id) {
	      ...
	      !item ? invariant$1(false, "Could not find removed draggable \"" + id + "\"") : void 0;
	      return item;
	...
	var throwIfSpacingChange = function throwIfSpacingChange(old, fresh) {
	  {
	    ...
	    !isEqual$1(old.margin, fresh.margin) ? invariant$1(false, getMessage('margin')) : void 0;
	    !isEqual$1(old.border, fresh.border) ? invariant$1(false, getMessage('border')) : void 0;
	    !isEqual$1(old.padding, fresh.padding) ? invariant$1(false, getMessage('padding')) : void 0;
	  }
	};
	...
	var updateDroppables = (function (_ref) {
	  ...
	  var adjusted = modified.map(function (provided) {
	    ...
	    !raw ? invariant$1(false, 'Could not locate droppable in existing droppables') : void 0;
...

	    {
	      ...
	      !isFrameEqual ? invariant$1(false, 'The width and height of your Droppable scroll container cannot change when adding or removing Draggables during a drag') : void 0;
	    }
	...
	var publishWhileDragging = (function (_ref) {
	  ...
	  !!isOrphaned ? invariant$1(false, 'Dragging item no longer has a valid merge/destination after a dynamic update. This is not supported') : void 0;
	  finish(timingsKey);
	...
	var moveToNextCombine = (function (_ref) {
	  ...
	  !location ? invariant$1(false, 'Need a previous location to move from into a combine') : void 0;
	  ...
	  !(target !== draggable) ? invariant$1(false, 'Cannot combine with self') : void 0;
	  var merge = {
	...
	var moveToNewDroppable = (function (_ref) {
	  ...
	  !(targetIndex !== -1) ? invariant$1(false, 'Cannot find target in list') : void 0;
	...
	var reducer = (function (state, action) {
	  ...
	  if (action.type === 'MOVE_BY_WINDOW_SCROLL') {
	    ...
	    !state.isWindowScrollAllowed ? invariant$1(false, 'Window scrolling is currently not supported for fixed lists. Aborting drag') : void 0;
	  ...
	  return function (_ref) {
	    ...
	    return function (next) {
	      return function (action) {
	        ...
	        !(getState().phase === 'IDLE') ? invariant$1(false, 'Incorrect phase to start a drag') : void 0;
	        var scrollOptions = {
	  ...
	  var collect = function collect() {
	    ...
	    frameId = requestAnimationFrame(function () {
	      ...
	      var updated = keys$1(modified).map(function (id) {
	        ...
	        !entry ? invariant$1(false, 'Cannot find dynamically added droppable in cache') : void 0;
	...
	var createDimensionMarshal = (function (callbacks) {
	  ...
	  var publisher = createPublisher({
	    callbacks: {
	      ...
	      getCritical: function getCritical() {
	        !collection ? invariant$1(false, 'Cannot get critical when there is no collection') : void 0;
	  ...
	  var updateDraggable = function updateDraggable(previous, descriptor, getDimension) {
	    !entries.draggables[previous.id] ? invariant$1(false, 'Cannot update draggable registration as no previous registration was found') : void 0;
	  ...
	  var unregisterDraggable = function unregisterDraggable(descriptor) {
	    ...
	    !entry ? invariant$1(false, "Cannot unregister Draggable with id:\n      " + descriptor.id + " as it is not registered") : void 0;
	    ...
	    !(collection.critical.draggable.id !== descriptor.id) ? invariant$1(false, 'Cannot remove the dragging item during a drag') : void 0;
	    throwIfAddOrRemoveOfWrongType(collection, descriptor);
	  ...
	  var registerDroppable = function registerDroppable(descriptor, droppableCallbacks) {
	    ...
	    !!collection ? invariant$1(false, 'Cannot add a Droppable during a drag') : void 0;
	  };

	  var unregisterDroppable = function unregisterDroppable(descriptor) {
	    var entry = entries.droppables[descriptor.id];
	    !entry ? invariant$1(false, "Cannot unregister Droppable with id " + descriptor.id + " as as it is not registered") : void 0;
	  ...
	  var updateDroppableIsEnabled = function updateDroppableIsEnabled(id, isEnabled) {
	    !entries.droppables[id] ? invariant$1(false, "Cannot update is enabled flag of Droppable " + id + " as it is not registered") : void 0;
	  ...
	  var updateDroppableIsCombineEnabled = function updateDroppableIsCombineEnabled(id, isCombineEnabled) {
	    !entries.droppables[id] ? invariant$1(false, "Cannot update isCombineEnabled flag of Droppable " + id + " as it is not registered") : void 0;
	  ...
	  var updateDroppableScroll = function updateDroppableScroll(id, newScroll) {
	    !entries.droppables[id] ? invariant$1(false, "Cannot update the scroll on Droppable " + id + " as it is not registered") : void 0;
	  ...
	  var scrollDroppable = function scrollDroppable(id, change) {
	    var entry = entries.droppables[id];
	    !entry ? invariant$1(false, "Cannot scroll Droppable " + id + " as it is not registered") : void 0;
	  ...
	  var startPublishing = function startPublishing(request) {
	    ...
	    !entry ? invariant$1(false, 'Cannot find critical draggable entry') : void 0;
	    var home = entries.droppables[entry.descriptor.droppableId];
	    !home ? invariant$1(false, 'Cannot find critical droppable entry') : void 0;
	    var critical = {
	...
	var createFluidScroller = (function (_ref) {
	  ...
	  var cancelPending = function cancelPending() {
	    !dragging ? invariant$1(false, 'Cannot cancel pending fluid scroll when not started') : void 0;
	...
	function useStyleMarshal(uniqueId) {
	  ...
	  useIsomorphicLayoutEffect$1(function () {
	    ...
	    always.setAttribute(prefix$2 + "-always", uniqueContext);
	    dynamic.setAttribute(prefix$2 + "-dynamic", uniqueContext);
	  ...
	  var dragging = useCallbackOne(function () {
	    return setDynamicStyle(styles.dragging);
	  }, [setDynamicStyle, styles.dragging]);
	  var dropping = useCallbackOne(function (reason) {
	    if (reason === 'DROP') {
	  ...
	  var resting = useCallbackOne(function () {
	  ...
	  var marshal = useMemoOne(function () {
	    return {
	      dragging: dragging,
	      dropping: dropping,
	      resting: resting,
	...
	function useAnnouncer(uniqueId) {
	  var id = useMemoOne(function () {
	    return getId(uniqueId);
	  }, [uniqueId]);
	  var ref = React.useRef(null);
	  React.useEffect(function () {
	    !!ref.current ? invariant$1(false, 'Announcement node already mounted') : void 0;
	    ...
	    return function () {
	      ...
	      !toBeRemoved ? invariant$1(false, 'Cannot unmount announcement node') : void 0;
	      getBodyElement().removeChild(toBeRemoved);
	      ref.current = null;
	    };
	  }, [id]);
	  var announce = useCallbackOne(function (message) {
	    var el = ref.current;
	...
	function App(props) {
	  ...
	  var getResponders = useCallbackOne(function () {
	    return createResponders(lastPropsRef.current);
	  }, []);
	  var announce = useAnnouncer(uniqueId);
	  var styleMarshal = useStyleMarshal(uniqueId);
	  var lazyDispatch = useCallbackOne(function (action) {
	    storeRef.current.dispatch(action);
	  }, []);
	  var callbacks = useMemoOne(function () {
	  ...
	  var dimensionMarshal = useMemoOne(function () {
	    return createDimensionMarshal(callbacks);
	  }, []);
	  var autoScroller = useMemoOne(function () {
	  ...
	  storeRef = React.useRef(store);
	  var tryResetStore = useCallbackOne(function () {
	    var state = storeRef.current.getState();

	    if (state.phase !== 'IDLE') {
	      store.dispatch(clean$1({
	        shouldFlush: true
	      }));
	    }
	  }, []);
	  setOnError(tryResetStore);
	  var getCanLift = useCallbackOne(function (id) {
	    return canStartDrag(storeRef.current.getState(), id);
	  }, []);
	  var getIsMovementAllowed = useCallbackOne(function () {
	    return isMovementAllowed(storeRef.current.getState());
	  }, []);
	  var appContext = useMemoOne(function () {
	    return {
	...
	function DragDropContext(props) {
	  var uniqueId = useMemoOne(function () {
	...
	function useDroppableDimensionPublisher(args) {
	  ...
	  var descriptor = useMemoOne(function () {
	    return {
	      id: args.droppableId,
	      type: args.type
	    };
	  ...
	  var memoizedUpdateScroll = useMemoOne(function () {
	  ...
	  var getClosestScroll = useCallbackOne(function () {
	  ...
	  var updateScroll = useCallbackOne(function () {
	    var scroll = getClosestScroll();
	    memoizedUpdateScroll(scroll.x, scroll.y);
	  }, [getClosestScroll, memoizedUpdateScroll]);
	  var scheduleScrollUpdate = useMemoOne(function () {
	    return index$1(updateScroll);
	  }, [updateScroll]);
	  var onClosestScroll = useCallbackOne(function () {
	    var dragging = whileDraggingRef.current;
	  ...
	  var getDimensionAndWatchScroll = useCallbackOne(function (windowScroll, options) {
	  ...
	  var recollect = useCallbackOne(function (options) {
	    var dragging = whileDraggingRef.current;
	    var closest = getClosestScrollableFromDrag(dragging);
	  ...
	  var dragStopped = useCallbackOne(function () {
	    var dragging = whileDraggingRef.current;
	  ...
	  var scroll = useCallbackOne(function (change) {
	    var dragging = whileDraggingRef.current;
	...
	function Placeholder(props) {
	  ...
	  var tryClearAnimateOpenTimer = useCallbackOne(function () {
	  ...
	  var onSizeChangeEnd = useCallbackOne(function (event) {
	...
	function checkOwnProps(props) {
	  ...
	  !(typeof props.isDropDisabled === 'boolean') ? invariant$1(false, 'isDropDisabled must be a boolean') : void 0;
	  !(typeof props.isCombineEnabled === 'boolean') ? invariant$1(false, 'isCombineEnabled must be a boolean') : void 0;
	  !(typeof props.ignoreContainerClipping === 'boolean') ? invariant$1(false, 'ignoreContainerClipping must be a boolean') : void 0;
	}
	...
	function Droppable(props) {
	  ...
	  var getDroppableRef = useCallbackOne(function () {
	    return droppableRef.current;
	  }, []);
	  var getPlaceholderRef = useCallbackOne(function () {
	    return placeholderRef.current;
	  }, []);
	  var setDroppableRef = useCallbackOne(function (value) {
	    droppableRef.current = value;
	  }, []);
	  var setPlaceholderRef = useCallbackOne(function (value) {
	    placeholderRef.current = value;
	  }, []);
	  var onPlaceholderTransitionEnd = useCallbackOne(function () {
	  ...
	  var provided = useMemoOne(function () {
	    return {
	  ...
	  var droppableContext = useMemoOne(function () {
	    return {
	      droppableId: droppableId,
	      type: type
	    };
	...
	var createEventMarshal = (function () {
	  ...
	  var handle = function handle() {
	    !!isMouseDownHandled ? invariant$1(false, 'Cannot handle mouse down as it is already handled') : void 0;
	...
	function useMouseSensor(args) {
	  ...
	  var getIsCapturing = useCallbackOne(function () {
	    return Boolean(pendingRef.current || isDraggingRef.current);
	  }, []);
	  var schedule = useMemoOne(function () {
	    !!getIsCapturing() ? invariant$1(false, 'Should not recreate scheduler while capturing') : void 0;
	    return createScheduler(callbacks);
	  }, [callbacks, getIsCapturing]);
	  var postDragEventPreventer = useMemoOne(function () {
	    return createPostDragEventPreventer(getWindow);
	  }, [getWindow]);
	  var stop = useCallbackOne(function () {
	    if (!getIsCapturing()) {
	      return;
	    }
	  ...
	  var cancel = useCallbackOne(function () {
	  ...
	  var startDragging = useCallbackOne(function () {
	    !!isDraggingRef.current ? invariant$1(false, 'Cannot start a drag while dragging') : void 0;
	    var pending = pendingRef.current;
	    !pending ? invariant$1(false, 'Cannot start a drag without a pending drag') : void 0;
	    pendingRef.current = null;
	  ...
	  var windowBindings = useMemoOne(function () {
	    !!getIsCapturing() ? invariant$1(false, 'Should not recreate window bindings while capturing') : void 0;
	    var bindings = [{
	      eventName: 'mousemove',
	      fn: function fn(event) {
	        ...
	        if (!pending) {
	          stop();
	          invariant$1(false, 'Expected there to be an active or pending drag when window mousemove event is received');
	        }
	      ...
	      fn: function fn(event) {
	        if (event.webkitForce == null || MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN == null) {
	          warning('handling a mouse force changed event when it is not supported');
	          return;
	        }
	  ...
	  var bindWindowEvents = useCallbackOne(function () {
	    var win = getWindow();
	    var options = {
	      capture: true
	    };
	  ...
	  var startPendingDrag = useCallbackOne(function (point) {
	    !!pendingRef.current ? invariant$1(false, 'Expected there to be no pending drag') : void 0;
	    pendingRef.current = point;
	    onCaptureStart(stop);
	    bindWindowEvents();
	  }, [bindWindowEvents, onCaptureStart, stop]);
	  var onMouseDown = useCallbackOne(function (event) {
	    if (mouseDownMarshal.isHandled()) {
	      return;
	    }

	    !!getIsCapturing() ? invariant$1(false, 'Should not be able to perform a mouse down while a drag or pending drag is occurring') : void 0;
	...
	function useKeyboardSensor(args) {
	  ...
	  var getIsDragging = useCallbackOne(function () {
	    return isDraggingRef.current;
	  }, []);
	  var schedule = useMemoOne(function () {
	    !!getIsDragging() ? invariant$1(false, 'Should not recreate scheduler while capturing') : void 0;
	    return createScheduler(callbacks);
	  ...
	  var windowBindings = useMemoOne(function () {
	    !!getIsDragging() ? invariant$1(false, 'Should not recreate window bindings when dragging') : void 0;
	    return [{
	      eventName: 'mousedown',
	      fn: cancel
	    }, {
	  ...
	  var startDragging = useCallbackOne(function () {
	    ...
	    !ref ? invariant$1(false, 'Cannot start a keyboard drag without a draggable ref') : void 0;
	    isDraggingRef.current = true;
	    onCaptureStart(stop);
	    bindWindowEvents();
	  ...
	  var onKeyDown = useCallbackOne(function (event) {
	    if (!getIsDragging()) {
	...
	function useTouchSensor(args) {
	  ...
	  var postDragClickPreventer = useMemoOne(function () {
	    return createPostDragEventPreventer(getWindow);
	  }, [getWindow]);
	  var schedule = useMemoOne(function () {
	    !!getIsCapturing() ? invariant$1(false, 'Should not recreate scheduler while capturing') : void 0;
	  ...
	  var stop = useCallbackOne(function () {
	    ...
	    var pending = pendingRef.current;
	    !pending ? invariant$1(false, 'Expected a pending drag') : void 0;
	  ...
	  var startPendingDrag = useCallbackOne(function (event) {
	    !!pendingRef.current ? invariant$1(false, 'Expected there to be no pending drag') : void 0;
	    var touch = event.touches[0];
	  ...
	  var onTouchStart = function onTouchStart(event) {
	    ...
	    !!getIsCapturing() ? invariant$1(false, 'Should not be able to perform a touch start while a drag or pending drag is occurring') : void 0;
	  ...
	  React.useEffect(function () {
	    {
	      ...
	      !draggableRef ? invariant$1(false, 'Drag handle was unable to find draggable ref') : void 0;
	...
	function useFocusRetainer(args) {
	  ...
	  var onFocus = useCallbackOne(function () {
	    isFocusedRef.current = true;
	  }, []);
	  var onBlur = useCallbackOne(function () {
	  ...
	  useIsomorphicLayoutEffect$1(function () {
	    ...
	    !draggable ? invariant$1(false, 'Drag handle could not obtain draggable ref') : void 0;
	  ...
	  var lastDraggableRef = React.useRef(getDraggableRef());
	  useIsomorphicLayoutEffect$1(function () {
	    var draggableRef = getDraggableRef();
	...
	function useDragHandle(args) {
	  ...
	  var onCaptureStart = useCallbackOne(function (abort) {
	    !!capturingRef.current ? invariant$1(false, 'Cannot start capturing while something else is') : void 0;
	    capturingRef.current = {
	      abort: abort
	    };
	  }, []);
	  var onCaptureEnd = useCallbackOne(function () {
	    !capturingRef.current ? invariant$1(false, 'Cannot stop capturing while nothing is capturing') : void 0;
	    capturingRef.current = null;
	  }, []);
	  var abortCapture = useCallbackOne(function () {
	    !capturingRef.current ? invariant$1(false, 'Cannot abort capture when there is none') : void 0;
	  ...
	  var getWindow = useCallbackOne(function () {
	    return getWindowFromEl(getDraggableRef());
	  }, [getDraggableRef]);
	  var canStartCapturing = useCallbackOne(function (event) {
	    if (!isEnabled) {
	      return false;
	    }
	  ...
	  var mouseArgs = useMemoOne(function () {
	    return {
	      callbacks: callbacks,
	      getDraggableRef: getDraggableRef,
	      getWindow: getWindow,
	  ...
	  var keyboardArgs = useMemoOne(function () {
	    return {
	      callbacks: callbacks,
	      getDraggableRef: getDraggableRef,
	      getWindow: getWindow,
	  ...
	  var touchArgs = useMemoOne(function () {
	    return {
	      callbacks: callbacks,
	      getDraggableRef: getDraggableRef,
	      getWindow: getWindow,
	...
	function useDraggableDimensionPublisher(args) {
	  ...
	  var publishedDescriptorRef = React.useRef(descriptor);
	  var makeDimension = useCallbackOne(function (windowScroll) {
	...
	function checkOwnProps$1(props) {
	  !isInteger$1(props.index) ? invariant$1(false, 'Draggable requires an integer index prop') : void 0;
	  !props.draggableId ? invariant$1(false, 'Draggable requires a draggableId') : void 0;
	  !(typeof props.isDragDisabled === 'boolean') ? invariant$1(false, 'isDragDisabled must be a boolean') : void 0;
	}
	...
	function Draggable(props) {
	  var ref = React.useRef(null);
	  var setRef = useCallbackOne(function (el) {
	    ref.current = el;
	  }, []);
	  var getRef = useCallbackOne(function () {
	    return ref.current;
	  }, []);
	  var appContext = useRequiredContext(AppContext);
	  ...
	  var forPublisher = useMemoOne(function () {
	    return {
	  ...
	  var onLift = useCallbackOne(function (options) {
	    start('LIFT');
	    var el = ref.current;
	    !el ? invariant$1(false) : void 0;
	    !!isDragDisabled ? invariant$1(false, 'Cannot lift a Draggable when it is disabled') : void 0;
	  ...
	  var getShouldRespectForcePress = useCallbackOne(function () {
	  ...
	  var dragHandleArgs = useMemoOne(function () {
	    return {
	      draggableId: draggableId,
	  ...
	  var onMoveEnd = useCallbackOne(function (event) {
