...
function useStyleMarshal(uniqueId) {
  var uniqueContext = useMemoOne.useMemoOne(function () {
    return "" + uniqueId;
  }, [uniqueId]);
  var styles = useMemoOne.useMemoOne(function () {
    return getStyles$1(uniqueContext);
  }, [uniqueContext]);
  var alwaysRef = React.useRef(null);
  var dynamicRef = React.useRef(null);
  var setDynamicStyle = useMemoOne.useCallbackOne(memoizeOne(function (proposed) {
    var el = dynamicRef.current;
    !el ? process.env.NODE_ENV !== "production" ? invariant(false, 'Cannot set dynamic style element if it is not set') : invariant(false) : void 0;
    el.textContent = proposed;
  }), []);
  var setAlwaysStyle = useMemoOne.useCallbackOne(function (proposed) {
  ...
  var dragging = useMemoOne.useCallbackOne(function () {
    return setDynamicStyle(styles.dragging);
  }, [setDynamicStyle, styles.dragging]);
  var dropping = useMemoOne.useCallbackOne(function (reason) {
    if (reason === 'DROP') {
  ...
  var resting = useMemoOne.useCallbackOne(function () {
  ...
  var marshal = useMemoOne.useMemoOne(function () {
    return {
      dragging: dragging,
      dropping: dropping,
      resting: resting,
...
function useAnnouncer(uniqueId) {
  var id = useMemoOne.useMemoOne(function () {
  ...
  var announce = useMemoOne.useCallbackOne(function (message) {
    var el = ref.current;
...
function App(props) {
  ...
  var getResponders = useMemoOne.useCallbackOne(function () {
    return createResponders(lastPropsRef.current);
  }, []);
  var announce = useAnnouncer(uniqueId);
  var styleMarshal = useStyleMarshal(uniqueId);
  var lazyDispatch = useMemoOne.useCallbackOne(function (action) {
    storeRef.current.dispatch(action);
  }, []);
  var callbacks = useMemoOne.useMemoOne(function () {
  ...
  var dimensionMarshal = useMemoOne.useMemoOne(function () {
    return createDimensionMarshal(callbacks);
  }, []);
  var autoScroller = useMemoOne.useMemoOne(function () {
  ...
  var store = useMemoOne.useMemoOne(function () {
    return createStore({
  ...
  var tryResetStore = useMemoOne.useCallbackOne(function () {
  ...
  var getCanLift = useMemoOne.useCallbackOne(function (id) {
    return canStartDrag(storeRef.current.getState(), id);
  }, []);
  var getIsMovementAllowed = useMemoOne.useCallbackOne(function () {
    return isMovementAllowed(storeRef.current.getState());
  }, []);
  var appContext = useMemoOne.useMemoOne(function () {
    return {
...
function DragDropContext(props) {
  var uniqueId = useMemoOne.useMemoOne(function () {
...
function useDroppableDimensionPublisher(args) {
  ...
  var descriptor = useMemoOne.useMemoOne(function () {
    return {
      id: args.droppableId,
      type: args.type
    };
  ...
  var memoizedUpdateScroll = useMemoOne.useMemoOne(function () {
  ...
  var getClosestScroll = useMemoOne.useCallbackOne(function () {
  ...
  var updateScroll = useMemoOne.useCallbackOne(function () {
    var scroll = getClosestScroll();
    memoizedUpdateScroll(scroll.x, scroll.y);
  }, [getClosestScroll, memoizedUpdateScroll]);
  var scheduleScrollUpdate = useMemoOne.useMemoOne(function () {
    return rafSchd(updateScroll);
  }, [updateScroll]);
  var onClosestScroll = useMemoOne.useCallbackOne(function () {
    var dragging = whileDraggingRef.current;
  ...
  var getDimensionAndWatchScroll = useMemoOne.useCallbackOne(function (windowScroll, options) {
  ...
  var recollect = useMemoOne.useCallbackOne(function (options) {
    var dragging = whileDraggingRef.current;
    var closest = getClosestScrollableFromDrag(dragging);
  ...
  var dragStopped = useMemoOne.useCallbackOne(function () {
    var dragging = whileDraggingRef.current;
  ...
  var scroll = useMemoOne.useCallbackOne(function (change) {
    var dragging = whileDraggingRef.current;
...
function Placeholder(props) {
  ...
  var tryClearAnimateOpenTimer = useMemoOne.useCallbackOne(function () {
  ...
  var onSizeChangeEnd = useMemoOne.useCallbackOne(function (event) {
...
function Droppable(props) {
  ...
  var getDroppableRef = useMemoOne.useCallbackOne(function () {
    return droppableRef.current;
  }, []);
  var getPlaceholderRef = useMemoOne.useCallbackOne(function () {
    return placeholderRef.current;
  }, []);
  var setDroppableRef = useMemoOne.useCallbackOne(function (value) {
    droppableRef.current = value;
  }, []);
  var setPlaceholderRef = useMemoOne.useCallbackOne(function (value) {
    placeholderRef.current = value;
  }, []);
  var onPlaceholderTransitionEnd = useMemoOne.useCallbackOne(function () {
  ...
  var provided = useMemoOne.useMemoOne(function () {
    return {
  ...
  var droppableContext = useMemoOne.useMemoOne(function () {
    return {
      droppableId: droppableId,
      type: type
    };
...
function useMouseSensor(args) {
  ...
  var getIsCapturing = useMemoOne.useCallbackOne(function () {
    return Boolean(pendingRef.current || isDraggingRef.current);
  }, []);
  var schedule = useMemoOne.useMemoOne(function () {
  ...
  var postDragEventPreventer = useMemoOne.useMemoOne(function () {
    return createPostDragEventPreventer(getWindow);
  }, [getWindow]);
  var stop = useMemoOne.useCallbackOne(function () {
    if (!getIsCapturing()) {
      return;
    }
  ...
  var cancel = useMemoOne.useCallbackOne(function () {
  ...
  var startDragging = useMemoOne.useCallbackOne(function () {
  ...
  var windowBindings = useMemoOne.useMemoOne(function () {
  ...
  var bindWindowEvents = useMemoOne.useCallbackOne(function () {
    var win = getWindow();
    var options = {
      capture: true
    };
  ...
  var startPendingDrag = useMemoOne.useCallbackOne(function (point) {
  ...
  var onMouseDown = useMemoOne.useCallbackOne(function (event) {
...
function useKeyboardSensor(args) {
  ...
  var getIsDragging = useMemoOne.useCallbackOne(function () {
  ...
  var onKeyDown = useMemoOne.useCallbackOne(function (event) {
    if (!getIsDragging()) {
...
function useTouchSensor(args) {
  ...
  var postDragClickPreventer = useMemoOne.useMemoOne(function () {
    return createPostDragEventPreventer(getWindow);
  }, [getWindow]);
  var schedule = useMemoOne.useMemoOne(function () {
    !!getIsCapturing() ? process.env.NODE_ENV !== "production" ? invariant(false, 'Should not recreate scheduler while capturing') : invariant(false) : void 0;
  ...
  var startPendingDrag = useMemoOne.useCallbackOne(function (event) {
    !!pendingRef.current ? process.env.NODE_ENV !== "production" ? invariant(false, 'Expected there to be no pending drag') : invariant(false) : void 0;
    var touch = event.touches[0];
...
function useFocusRetainer(args) {
  ...
  var onFocus = useMemoOne.useCallbackOne(function () {
    isFocusedRef.current = true;
  }, []);
  var onBlur = useMemoOne.useCallbackOne(function () {
...
function useDragHandle(args) {
  ...
  var onCaptureStart = useMemoOne.useCallbackOne(function (abort) {
  ...
  var onCaptureEnd = useMemoOne.useCallbackOne(function () {
  ...
  var abortCapture = useMemoOne.useCallbackOne(function () {
  ...
  var getWindow = useMemoOne.useCallbackOne(function () {
    return getWindowFromEl(getDraggableRef());
  }, [getDraggableRef]);
  var canStartCapturing = useMemoOne.useCallbackOne(function (event) {
    if (!isEnabled) {
      return false;
    }
  ...
  var mouseArgs = useMemoOne.useMemoOne(function () {
    return {
      callbacks: callbacks,
      getDraggableRef: getDraggableRef,
      getWindow: getWindow,
  ...
  var keyboardArgs = useMemoOne.useMemoOne(function () {
    return {
      callbacks: callbacks,
      getDraggableRef: getDraggableRef,
      getWindow: getWindow,
  ...
  var touchArgs = useMemoOne.useMemoOne(function () {
    return {
      callbacks: callbacks,
      getDraggableRef: getDraggableRef,
      getWindow: getWindow,
  ...
  var props = useMemoOne.useMemoOne(function () {
    if (!isEnabled) {
      return null;
    }
...
function useDraggableDimensionPublisher(args) {
  ...
  var publishedDescriptorRef = React.useRef(descriptor);
  var makeDimension = useMemoOne.useCallbackOne(function (windowScroll) {
...
function Draggable(props) {
  var ref = React.useRef(null);
  var setRef = useMemoOne.useCallbackOne(function (el) {
    ref.current = el;
  }, []);
  var getRef = useMemoOne.useCallbackOne(function () {
    return ref.current;
  }, []);
  var appContext = useRequiredContext(AppContext);
  ...
  var forPublisher = useMemoOne.useMemoOne(function () {
    return {
  ...
  var onLift = useMemoOne.useCallbackOne(function (options) {
    start('LIFT');
    var el = ref.current;
  ...
  var getShouldRespectForcePress = useMemoOne.useCallbackOne(function () {
  ...
  var dragHandleArgs = useMemoOne.useMemoOne(function () {
    return {
      draggableId: draggableId,
  ...
  var onMoveEnd = useMemoOne.useCallbackOne(function (event) {
